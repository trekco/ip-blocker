...
namespace Trekco.IpBlocker.WindowsFirewall
{
    public class WindowsFirewallIpBlocker : IFirewallIpBlocker
    {
        ...
        private readonly Dictionary<string, List<INetFwRule>> _rules;
        ...
        public bool Block(BlockedEntry blockEntry, IPBlockPolicy policy, out string ruleName)
        {
            ...
            else
            {
                ...
                rule.Protocol =
                    (int) blockEntry
                        .Protocol; //NET_FW_IP_PROTOCOL_.NET_FW_IP_PROTOCOL_TCP / NET_FW_IP_PROTOCOL_.NET_FW_IP_PROTOCOL_UDP
