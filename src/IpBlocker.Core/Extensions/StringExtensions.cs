...
namespace Trekco.IpBlocker.Core.Extensions
{
    public static class StringExtensions
    {
        ...
        //     {
        //         return value.ToStringArray().Cast<T>().ToList();
        //     }
        //
        ...
        {
            return int.TryParse(value, out var returnVal) ? returnVal : default;
        }
        ...
        public static double ToDouble(this string? value)
        {
            return double.TryParse(value,
                NumberStyles.Number | NumberStyles.AllowCurrencySymbol | NumberStyles.AllowLeadingWhite |
